...
# 👋 Hey Everyone, I'm **Enoch Agboola**

## 🚀 Welcome to My GitHub Universe!

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3000&pause=1000&color=0891B2&center=true&vCenter=true&width=700&lines=Full-Stack+Web+Developer+%F0%9F%87%B3%F0%9F%87%AC;Next.js+%7C+TypeScript+%7C+Node.js+%7C+PostgreSQL;Building+products+that+are+clean%2C+fast+%26+useful;Open+to+collabs%2C+startup+ideas+%26+creative+builds!)](https://git.io/typing-svg)
...
- 🏗️ Building **RepoPilot** — an AI-powered GitHub assistant SaaS
- 🗳️ Finalizing **RUNSA Digital Voting System** as my Final Year Project
- 🌱 Currently deepening skills in **backend architecture, auth systems & scalable design**
- 🤝 Open to collaborating on **full-stack apps, startup ideas & creative digital products**
- 💬 Ask me about **React, Next.js, Node.js, PostgreSQL, Tailwind**
- 📍 Based in **Nigeria 🇳🇬**
- 📫 Reach me at **enochbobo28@gmail.com**
...
|---|---|---|
| 🤖 [**RepoPilot**](#) | AI GitHub assistant — README gen, project suggestions, commit scheduler | Next.js 14, Supabase, Anthropic API |
| 🗳️ [**RUNSA Voting System**](#) | Secure digital election platform with JWT, RBAC & SHA-256 vote hashing | Next.js, Node.js, PostgreSQL, Prisma |
| ⚡ [**GitPulse**](#) | Developer analytics + AI code generation engine | React, Node.js |
| 💼 [**Freelance CRM**](#) | Client management with invoice PDF gen & email automation | React, Node.js, MongoDB, JWT |
| 🛍️ [**TechStream**](#) | E-commerce platform with wishlist, reviews & cart | React, Firebase |
| 🏠 [**Hostel Complaint App**](#) | University complaint tracker — Student → Admin → Artisan workflow | Next.js 14, NextAuth, PostgreSQL |
